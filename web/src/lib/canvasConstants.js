...
// tuning and generic toolbar tool descriptors. Historic starter conditions
// are re-exported from a separate archive for compatibility only.
...
// Legacy feature defaults are declared centrally in legacyTradeBehavior.js.

import { LEGACY_TRADE_FEATURES } from "./legacyTradeBehavior.js";
export { FLOORING_DEFAULTS } from "./legacyFlooringDefaults.js";
...
export const ROLL_GOODS_UI_ENABLED = LEGACY_TRADE_FEATURES.rollGoodsUi;
