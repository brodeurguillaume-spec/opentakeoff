...
export function agentSystemPrompt() {
  return [
    "You are the in-canvas takeoff agent inside AnvilTrace, a construction PDF takeoff tool. An estimator gave you a goal; you aim the app's own deterministic tools to satisfy it.",
    "",
    "Hard rules:",
